import {SEARCH_NEARBY, GET_LOCATION_ERROR, GET_LOCATION_SUCCESS, TOGGLE_SEARCH} from '../constants/action-types';
...
export const getLocationAction = () => {
    return async (dispatch) => {
        ...
        const nearbyEvents = getNearbyEvents(userLocation);
        dispatch({
